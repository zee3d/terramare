...
function _screenshot_on_the_next_frame(callback, x, y, w, h) {
  ...
  window.requestAnimationFrame = function (f) {
    ...
    setTimeout(function () {
      getWasmTableEntry(callback)(bs64_img);
...
var wasmImports = {
  Sh: _DefPointerLock_ExitPointerLock,
  Rh: _DefPointerLock_Final,
  Qh: _DefPointerLock_Init,
  Ph: _DefPointerLock_RequestPointerLock,
  b: ___assert_fail,
  ...
  Fh: ___syscall_mkdirat,
  Z: ___syscall_openat,
  Eh: ___syscall_poll,
  Dh: ___syscall_readlinkat,
  Ch: ___syscall_recvfrom,
  Bh: ___syscall_renameat,
  Ah: ___syscall_rmdir,
  zh: ___syscall_sendto,
  va: ___syscall_socket,
  yh: ___syscall_stat64,
  Y: ___syscall_unlinkat,
  vh: __emscripten_get_now_is_monotonic,
  uh: __emscripten_lookup_name,
  th: __emscripten_system,
  sh: __emscripten_throw_longjmp,
  Ca: __gmtime_js,
  Ba: __localtime_js,
  Aa: __mktime_js,
  rh: __tzset_js,
  k: _abort,
  qh: defos_set_cursor_locked_,
  ph: _dmDeviceJSFreeBufferSlots,
  oh: _dmDeviceJSOpen,
  nh: _dmDeviceJSQueue,
  mh: _dmGetDeviceSampleRate,
  lh: _dmScriptHttpRequestAsync,
  kh: _dmSysGetApplicationPath,
  jh: _dmSysGetUserAgent,
  ih: _dmSysGetUserPersistentDataRoot,
  hh: _dmSysGetUserPreferredLanguage,
  gh: _dmSysOpenURL,
  ta: _emscripten_asm_const_double,
  e: _emscripten_asm_const_int,
  fh: _emscripten_cancel_main_loop,
  ...
  Pb: _glDepthMask,
  Ob: _glDisable,
  Nb: _glDisableVertexAttribArray,
  Mb: _glDrawArrays,
  Lb: _glDrawBuffers,
  Kb: _glDrawElements,
  Jb: _glEnable,
  Ib: _glEnableVertexAttribArray,
  Hb: _glFlush,
  Gb: _glFramebufferRenderbuffer,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Th"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Uh"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Vh"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Wh"])(a0);
};
...
var _defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = function (a0) {
  return (_defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = wasmExports["Zh"])(a0);
};
...
var ___start_em_js = Module["___start_em_js"] = 285129;
var ___stop_em_js = Module["___stop_em_js"] = 285524;
